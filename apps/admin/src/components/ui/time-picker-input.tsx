    ...
    (
        ...
        return (
            <input
                ...
                name={name || picker}
                className={cn(
                    "flex h-9 w-[48px] rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors",
                    "text-center font-mono text-base tabular-nums caret-transparent",
